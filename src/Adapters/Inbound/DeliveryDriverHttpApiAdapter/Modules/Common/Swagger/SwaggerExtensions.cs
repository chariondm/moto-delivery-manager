...
public static class SwaggerExtensions
{
    ...
    public static IServiceCollection AddCustomSwagger(this IServiceCollection services)
    {
        services.AddSwaggerGen(options =>
        {
            options.SwaggerDoc("v1", new OpenApiInfo
            {
                ...
                Description = "This ASP.NET Core Web API is designed to manage delivery drivers as part of a motorcycle delivery service.",
    ...
    public static IApplicationBuilder UseCustomSwagger(this IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        {
            app.UseSwagger();
            app.UseSwaggerUI(options => options.SwaggerEndpoint("/swagger/v1/swagger.json", "Delivery Driver Management API v1"));
        }
